...
from data_base.orm_query import orm_get_products, orm_get_product, orm_get_training, orm_get_uniducts, orm_add_id
...
async def start_cmd(message: types.Message):
    #await orm_add_id(session, data={id=message.chat.id, })
